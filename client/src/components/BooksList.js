...
const tableIcons = {
    ...
    Check: forwardRef((props, ref) => <Check {...props} ref={ref} style={{ color: green[500] }}/>),
    Clear: forwardRef((props, ref) => <Clear {...props} ref={ref} style={{ color: red[500] }}/>),
    Delete: forwardRef((props, ref) => <DeleteOutline {...props} ref={ref} style={{ color: red[500] }} />),
